...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/admin/home/img/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/admin/home/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/admin/home/img/favicons/favicon-16x16.png">
    <link rel="shortcut icon" type="image/x-icon" href="/admin/home/img/favicons/favicon.ico">
    <link rel="manifest" href="/admin/home/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="/admin/home/img/favicons/mstile-150x150.png">
    <meta name="theme-color" content="#ffffff">

    {{-- <link href="{{ asset('admin/assets/css/bootstrap.min.css') }}" rel="stylesheet" /> --}}
    <link href="{{ asset('admin/home/css/theme.min.css') }}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bolder fs-2 fst-italic" href="{{ route('home') }}">
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              <li class="nav-item px-2"><a class="nav-link fw-medium active" aria-current="page" href="{{ route('home') }}">Home</a></li>
      ...
      <section class="py-0" id="home">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(/admin/home/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-sm-none" style="background-image:url(/admin/home/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
        </div>
        <!--/.bg-holder-->
              ...
              <div class="pt-3">
                <form>
                  <div class="input-group w-xl-75 w-xxl-50 d-flex flex-end-center">
                    <input class="form-control rounded-pill shadow-lg border-0" id="formGroupExampleInput" type="text" placeholder="Seacrh by skill, company and job" /><img class="input-box-icon me-2" src="/admin/home/img/illustrations/search.png" width="30" alt="" />
                  </div>
                </form>
              </div>
            </div>
      ...
      <section class="py-5">
        <div class="bg-holder" style="background-image:url(/admin/home/img/illustrations/bg.png);background-position:left top;background-size:initial;margin-top:-180px;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-0 text-center text-md-start"><img class="img-fluid mb-4" src="/admin/home/img/illustrations/passion.png" width="450" alt="" /></div>
      ...
      <section class="py-0">
        <div class="container">
          <section class="py-8">
            ...
            <div class="container">
              <div class="row flex-center">
                <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="/admin/home/img/illustrations/jobs.png" width="450" alt="" /></div>
                <div class="col-md-5 text-center text-md-start">
      ...
      <section class="py-5">
        <div class="bg-holder d-none d-sm-block" style="background-image:url(/admin/home/img/illustrations/category-bg.png);background-position:right top;background-size:200px 320px;">
        </div>
        <div class="container">
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="/admin/home/img/illustrations/finance.png" height="120" alt="" />
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="/admin/home/img/illustrations/design.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="/admin/home/img/illustrations/programmer.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="/admin/home/img/illustrations/production.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="/admin/home/img/illustrations/education.png" height="120" alt="" />
                      <div class="card-body px-2">
                ...
                <div class="col-sm-6 col-lg-4 pb-lg-6 px-lg-4 pb-4">
                  <div class="card py-4 shadow-sm h-100 hover-top">
                    <div class="text-center"> <img src="/admin/home/img/illustrations/consultancy.png" height="120" alt="" />
                      <div class="card-body px-2">
      ...
      <section class="py-8">
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="/admin/home/img/illustrations/feature.png" width="450" alt="" /></div>
            <div class="col-md-5 text-center text-md-start">
      ...
      <section class="py-0"><img class="w-100" src="/admin/home/img/illustrations/come-on-join.png" alt="" />
        <div class="container">
                    ...
                    <div class="row h-100 m-lg-7 mx-3 mt-6 mx-md-4 my-md-7">
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="/admin/home/img/gallery/user-1.png" alt="" /></div>
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="/admin/home/img/gallery/user-2.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow-lg">
                          <div class="card-span-img"><img src="/admin/home/img/gallery/user-3.png" alt="" /></div>
                          <div class="card-body d-flex flex-column flex-center py-6">
                            <div class="my-4">
                              <ul class="list-unstyled list-inline">
                                <li class="list-inline-item me-0">
      ...
      <section class="py-0 bg-primary-gradient">
        <div class="bg-holder" style="background-image:url(/admin/home/img/illustrations/footer-bg.png);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
