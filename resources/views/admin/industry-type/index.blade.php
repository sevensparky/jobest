...
@section('title', __('admin_panel_industry_type'))
    ...
    <div class="card radius-10 {{ app()->getLocale('fa') ? 'd-rtl' : '' }}">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <div>
                    <h6 class="mb-0">{{ __('industry_type') }}</h6>
                </div>
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item"
                                href="{{ route('industry-type.create') }}">{{ __('create_industry_type') }}</a>
                        </li>
                        <li>
                                    ...
                                    <td>
                                        <div class="col-md-12">
                                            <div class="d-md-flex d-grid align-items-center justify-content-center gap-3">
                                                <a href="{{ route('industry-type.edit', $item->id) }}" type="buttom"
                                                    class="btn btn-sm btn-warning px-4">
                                                    {{ __('edit') }}</a>
                                                <form action="{{ route('industry-type.destroy', $item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
