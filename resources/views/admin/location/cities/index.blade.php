...
@section('title', __('admin_panel_cities'))
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item"
                                href="{{ route('cities.create') }}">{{ __('create_new_city') }}</a>
                        </li>
                        <li>
                                    ...
                                    <td>
                                        <div class="col-md-12">
                                            <div class="d-md-flex d-grid align-items-center justify-content-center gap-3">
                                                <a href="{{ route('cities.edit', $city->id) }}" type="buttom"
