...
@section('content')
    <div class="col-xl-10 mx-auto {{ app()->getLocale('fa') ? 'd-rtl' : '' }}">        <div class="card">
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('settings.store') }}" class="row g-3 needs-validation"
                    enctype="multipart/form-data" novalidate="">
                    @csrf
                    <div class="col-md-6">
                        <label for="title" class="form-label">{{ __('title_of_brand') }}</label>
                        <input type="text" class="form-control" name="title" id="title"
                            value="{{ old('title', optional($article ?? null)->title) }}"
                            placeholder="{{ __('enter_your_brand') }}" required="">
                        @error('title')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" name="email" id="email"
                            value="{{ old('email', optional($article ?? null)->email) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="tel" id="tel"
                            value="{{ old('tel', optional($article ?? null)->tel) }}"
                            placeholder="{{ __('enter_tel_number') }}" required="">
                        @error('tel')
                            <small class="text text-danger"><b>{{ $message }}</b></small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="phone" id="phone"
                            value="{{ old('phone', optional($article ?? null)->phone) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="address" id="address"
                            value="{{ old('address', optional($article ?? null)->address) }}"
                            placeholder="{{ __('enter_address') }}" required="">
                        @error('address')
                            <small class="text text-danger"><b>{{ $message }}</b></small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-2">
                            <img src="" alt="" id="preview_image" class="img-fluid"
                                value="{{ old('image', optional($article ?? null)->image) }}">
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea type="text" class="form-control resize-none" name="description" id="description"
                            value="{{ old('description', optional($article ?? null)->description) }}" cols="5" rows="5"
                            placeholder="{{ __('enter_description') }}" required=""></textarea>
